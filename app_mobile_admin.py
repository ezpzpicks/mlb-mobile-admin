...
if selected_sport not in valid_sports:
    ...
    st.caption("MLB remains the production engine. NFL now includes the first lineup-aware game engine. CFB and CBB remain foundation models for setup and shadow testing.")
    st.stop()

versions = {
    "MLB": "v15.0-k-overhaul-2026-07-13",
    "CFB": "cfb-v0.1-foundation-2026-07-13",
    "NFL": "nfl-v1.2-team-ratings-fix-2026-07-15",
