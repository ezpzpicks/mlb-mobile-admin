...
if selected_sport not in valid_sports:
    ...
    st.caption("MLB remains the production engine. NFL now includes an automated slate, lineup-aware game engine, and QB/RB/WR/TE prop model. CFB and CBB remain foundation models for setup and shadow testing.")
    st.stop()

versions = {
    "MLB": "v15.0-k-overhaul-2026-07-13",
    "CFB": "cfb-v0.1-foundation-2026-07-13",
    "NFL": "nfl-v2.1-clean-builder-role-transitions-2026-07-17",
