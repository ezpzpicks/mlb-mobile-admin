...
if selected_sport not in valid_sports:
    ...
    st.caption("MLB remains the production engine. CFB, NFL and CBB are foundation models intended for setup, historical backtesting and shadow testing before public release.")
    st.stop()

versions = {
    "MLB": "v15.0-k-overhaul-2026-07-13",
    "CFB": "cfb-v0.1-foundation-2026-07-13",
    "NFL": "nfl-v0.1-foundation-2026-07-13",
