...
def replace_dataset(
    ...
    The generic dataset schema is the migration compatibility layer. It keeps
    the exact legacy column payload while also indexing common sports fields so
    the application can move to normalized SQL queries incrementally.
    """
