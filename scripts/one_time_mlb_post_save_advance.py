...
old_start = '''def render_auto_matchup_builder(pitcher_this_year, pitcher_last_year, team_hitting, team_batting_rhp, team_batting_lhp, nrfi_pitchers, nrfi_rhp, nrfi_lhp, pitcher_arsenal_df=None, team_pitch_type_df=None, bullpen_stats=None, bullpen_fatigue_df=None):
...
new_start = '''def render_auto_matchup_builder(pitcher_this_year, pitcher_last_year, team_hitting, team_batting_rhp, team_batting_lhp, nrfi_pitchers, nrfi_rhp, nrfi_lhp, pitcher_arsenal_df=None, team_pitch_type_df=None, bullpen_stats=None, bullpen_fatigue_df=None):
...
if text.count(old_start) != 1:
    raise SystemExit(f"Expected one active MLB builder start block, found {text.count(old_start)}")
if text.count(old_end) != 1:
    raise SystemExit(f"Expected one MLB save completion block, found {text.count(old_end)}")
