...
Version 3.0 adds a full opportunity/efficiency player-prop engine with current-role
transitions, estimated route participation, charting and coverage matchups,
market-specific probability distributions, and rolling residual calibration.
...
MODEL_VERSION = "nfl-v3.0-in-depth-props-2026-07-17"
DEFAULT_SEASON = 2026
    ...
    with st.expander("Slate controls and test mode", expanded=False):
        ...
        if st.button("Force refresh automatic NFL data", use_container_width=True, key="nfl_force_refresh"):
            for cached_loader in [
                ...
                _defense_position_profiles, _prop_calibration_data,
            ]:
                try:
                    cached_loader.clear()
                except Exception:
